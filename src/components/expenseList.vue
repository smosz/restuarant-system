<template>
      ...
      <div class="max-w-screen-lg mx-auto py-6">
        <div class="bg-white rounded-lg shadow-lg p-6 tab">
          ...
          >
            ...
            <tbody>
              <tr v-for="expense in paginatedExpenses" :key="expense.uid">
                ...
                <td class="text-center py-4 border border-gray-300">
                  {{ expense.totalAmount > 0 ? 'UGX ' + expense.totalAmount.toLocaleString() : '0' }}
                </td>
          ...
          <div class="flex text-center justify-between">
            ...
            Expense Bal: UGX {{ expenseBalance.toLocaleString() }}
          </div>
          <div class="mt-2 text-center">
  ...
  const totalAmount = computed(() => {
    return expenses.value.reduce((total, expense) => total + expense.totalAmount, 0);
  });
  ...
  const expenseBalance = computed(() => {
    const totalExpenseMoney = expenseMoney.value.reduce((total, money) => total + money, 0);
