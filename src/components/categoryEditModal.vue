    ...
    >
      ...
      <div class="modal-content py-4 text-left px-6">
        ...
        <form @submit.prevent="updateCategory">
          ...
          <div class="mb-4">
            <label for="category-description" class="block text-gray-700 font-medium">Category Description:</label>
            <textarea
...
const updateCategory = async () => {
  try {
    ...
    errorMessage.value = "Failed to update Category. Please try again later.";
  }
};
</script>
